...
> [!NOTE]
> While this preset is active, a user _cannot_ actually adjust the separation/convergence in game. It makes sense as to why, but if user doesn't like this, they'll have to remove the trigger for the preset from the `d3dx.ini`
